...
import { MDBCard, MDBCardBody, MDBCol, MDBContainer, MDBIcon, MDBInput, MDBRadio, MDBRow } from 'mdb-react-ui-kit';
          ...
          <MDBCard className="rounded-3">
            <MDBCardBody className="mx-1 my-2">
              <div className="d-flex align-items-center">
                <div>
                  <MDBIcon fab icon="cc-visa" size="4x" className="text-black pe-3" />
                </div>
              </div>
              <div className="pt-3">
              ...
              <div className="d-flex justify-content-between align-items-center pb-1">
                ...
                <Modal show={show}>
                  ...
                  <Modal.Body>
                    ...
                    {location.state.passengerdata.map((passenger, index) => (
                      <div key={index}>
                        <p>Name: {passenger.name}</p>
                        <p>Aadhar: {passenger.aadhar}</p>
                        <p>Date of Birth: {passenger.dob}</p>
                        <p>Contact Number: {passenger.contact}</p>
                        <hr />
                      </div>
                    ))}
                  </Modal.Body>
